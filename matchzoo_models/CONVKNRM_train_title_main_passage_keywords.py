...
evaluate = mz.callbacks.EvaluateAllMetrics(model, x=pred_x, y=pred_y, batch_size=32,model_save_path='CONVKNRM_result_title_main_passage_keywords/CONVKNRM_title_main_passage_keywords', once_every=1)
